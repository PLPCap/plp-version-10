...
//	}
	...
	public List<PolicyBean> getMyCustomerPolicies(int agentId)
		...
		ResultSet resultSet = null;
		try{
			preparedStatement = connection.prepareStatement("select a.policy_number,a.policy_premium,a.account_number from policy a,accounts b where a.account_number = b.account_number and b.agent_name = ?");
