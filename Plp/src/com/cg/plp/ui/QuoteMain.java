...
public class QuoteMain {
	...
	//		System.out.println(policyQuestionsList);
			...
			while(policyQuestionsIterator.hasNext()){
				...
				System.out.println("enter options 1 or 2 or 3 or 4");
				int ans = sc.nextInt();
	...
	//		System.out.println(installment);
			...
			case 2:
				...
				Iterator<PolicyBean> policyBean = li.iterator();
				while(policyBean.hasNext()) {
					System.out.println(policyBean.next());
				}
...
//					}
				...
				//if (policyList != null) {
					...
					while (i.hasNext())
					{
						...
						int answer=0;
						answer = sc.nextInt();
						if(policyQuestions.getBusSegId()=="1001") 
						{
					switch(answer) {
